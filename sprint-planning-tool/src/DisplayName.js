    ...
    return (
        ...
        <div className="flex items-center justify-center h-screen grid grid-cols-1">
            <form>
                ...
                <div className="my-9">
                    <input type="submit" value="Let the race begin" className="rounded-full bg-yellow-500 text-white text-2xl md:text-3xl  font-semibold py-3 px-9 w-3/4 lg:w-1/4" />
                </div>
            </form>
        </div>
        </div>
